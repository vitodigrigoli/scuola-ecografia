...
- **Scala tipografica**: solo i token `--text-*` di `tokens.css` (`body` 16, `body-sm` 14 per testi e liste dentro le card, `card-desc` 13.5, `caption` 12…). Niente `font-size` intermedi ad hoc nei blocchi.
